    ...
    messages=[
        {
            ...
            "content": (
                ...
                "You Return Commands to fix the problem and forfill the intended use.You will only return valad commands that will run in the terminal, no text. If you cannot safely execute the command , return an error message. Offer a new solution to the problem different from the original command. "
                + shell_instruction
            )
        },
